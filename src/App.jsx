          ...
          <div className="w-full h-screen flex items-center justify-center bg-black">
            <div className="cntnr flex text-white w-full h-[80%] ">
              ...
              <div className="rg w-[30%] py-30">
                ...
                <p className="mt-5 text-[2vh] font-[Helvetica_Now_Display]">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Distinctio possimus, asperiores nam, omnis inventore nesciunt
                  a architecto eveniet saepe, ducimus necessitatibus at
                  voluptate.
                </p>
                <p className="mt-3 text-[2vh] font-[Helvetica_Now_Display]">
                ...
                <p className="mt-4 text-[2vh] font-[Helvetica_Now_Display]">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. At
                  eius illum fugit eligendi nesciunt quia similique velit
                  excepturi soluta tenetur illo repellat consectetur laborum
                  eveniet eaque, dicta, hic quisquam? Ex cupiditate ipsa nostrum
                ...
                <button className="bg-yellow-500 px-3 py-4 text-black mt-5 text-2xl">
                  Download Now
                </button>
              </div>
            </div>
